...
oes.ui.space.grid.setup = function (containerEl) {
  ...
  if (sim.scenario.observationUI && sim.scenario.observationUI.spaceView)
    size = sim.scenario.observationUI.spaceView.gridCellSize;
...
oes.ui.space.grid.i.dom.renderIntegerGrid = function () {
  ...
  var colors = sim.scenario.observationUI.gridCellValueColors ||
...
oes.ui.space.grid.o.dom.setupObjectGrid = function () {
  ...
  oes.ui.space.grid.o.dom.getGridCellColor = oes.ui.space.grid.o.dom.processColor(
      sim.scenario.observationUI.spaceView.gridCellColor);
  // initialize object views
  if (sim.scenario.observationUI) {
    obsUI = sim.scenario.observationUI;
    ...
    if (sim.scenario.observationUI.spaceView.showGridCellInfoOnFlyOver) {
...
oes.ui.space.grid.o.dom.createObjectViews = function () {
  var objViews = null;
  // initialize object views
  if (sim.scenario.observationUI && sim.scenario.observationUI.objectViews) {
    objViews = sim.scenario.observationUI.objectViews;
